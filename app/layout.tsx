...
export const metadata: Metadata = {
  ...
  title: {
    default: "Web Developer Portfolio | Qamrul Hassan Shajal",
    template: "%s | Qamrul Hassan Shajal Portfolio",
  },
  description:
    "Portfolio of Qamrul Hassan Shajal — Web Developer specialising in React, Next.js, TypeScript, and Tailwind CSS. Available for freelance work.",
  keywords: [
    "Web Developer", "React Developer", "Next.js", "TypeScript",
  ...
  openGraph: {
    ...
    description:
      "Web Developer specialising in React, Next.js, TypeScript, and Tailwind CSS.",
    siteName: "Qamrul Hassan Shajal Portfolio",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "@type": "Person",
      name: "Qamrul Hassan Shajal",
      jobTitle: "Web Developer",
      url: "https://qhs-portfolio-next16.vercel.app",
      sameAs: [
        "https://github.com/Qamrul-Hassan",
      ],
    }),
  }}
/>
